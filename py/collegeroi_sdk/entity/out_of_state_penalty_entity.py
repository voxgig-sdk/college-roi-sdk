...
from collegeroi_sdk.collegeroi_types import (
    OutOfStatePenalty,
    OutOfStatePenaltyListMatch,
)
...
class OutOfStatePenaltyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutOfStatePenaltyEntity(self._client, opts)
    ...
    def data_get(self) -> OutOfStatePenalty:
    ...
    def match_get(self) -> OutOfStatePenalty:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OutOfStatePenalty]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OutOfStatePenalty().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

...
class WorstRoiMajorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WorstRoiMajorEntity(self._client, opts)
    ...
    def data_get(self) -> WorstRoiMajor:
    ...
    def match_get(self) -> WorstRoiMajor:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[WorstRoiMajor]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.WorstRoiMajor().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

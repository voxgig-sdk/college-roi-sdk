...
from collegeroi_sdk.utility import register

# Load features
from collegeroi_sdk.feature.base_feature import CollegeRoiBaseFeature
from collegeroi_sdk.features import _has_feature, _make_feature
...
class CollegeRoiSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CollegeRoiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def BestValue(self, data=None) -> "BestValueEntity":
        ...
        from collegeroi_sdk.entity.best_value_entity import BestValueEntity
    ...
    def Openapi(self, data=None) -> "OpenapiEntity":
        ...
        from collegeroi_sdk.entity.openapi_entity import OpenapiEntity
    ...
    def OutOfStatePenalty(self, data=None) -> "OutOfStatePenaltyEntity":
        ...
        from collegeroi_sdk.entity.out_of_state_penalty_entity import OutOfStatePenaltyEntity
    ...
    def WorstRoiMajor(self, data=None) -> "WorstRoiMajorEntity":
        ...
        from collegeroi_sdk.entity.worst_roi_major_entity import WorstRoiMajorEntity

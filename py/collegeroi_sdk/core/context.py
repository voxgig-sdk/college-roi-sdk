...
from collegeroi_sdk.core.helpers import get_ctx_prop, to_map
...
class CollegeRoiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, CollegeRoiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CollegeRoiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CollegeRoiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CollegeRoiError(code, msg, self)

# CollegeRoi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CollegeRoiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CollegeRoiSDK(...) and CollegeRoiSDK.test(...) become
#      CollegeRoiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "collegeroi_sdk"
_SDK_CLASS = "CollegeRoiSDK"
...
_ENTITIES = {
    ...
    "Major": "major",
    "Openapi": "openapi",
    "OutOfStatePenalty": "out_of_state_penalty",
    "Slug": "slug",
    "State": "state",
    "Top50": "top_50",
    "WorstRoiMajor": "worst_roi_major",
}

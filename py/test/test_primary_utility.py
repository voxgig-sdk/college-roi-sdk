...
from collegeroi_sdk.core.response import CollegeRoiResponse
from collegeroi_sdk.core.operation import CollegeRoiOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CollegeRoiError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = CollegeRoiSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = CollegeRoiSDK.test(None, None)
        ...
        class TestInitFeature(CollegeRoiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CollegeRoiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CollegeRoiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CollegeRoiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CollegeRoiSDK.test(None, setup_opts)

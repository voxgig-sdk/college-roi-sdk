...
class CollegeRoiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CollegeRoiTestRunner.getenv("COLLEGEROI_TEST_LIVE")
        override = CollegeRoiTestRunner.getenv("COLLEGEROI_TEST_OVERRIDE")
        ...
        explain = CollegeRoiTestRunner.getenv("COLLEGEROI_TEST_EXPLAIN")

...
func registerSDKWords(r *eng.Registry, client *sdk.CollegeRoiSDK) {
...
func runOp(client *sdk.CollegeRoiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

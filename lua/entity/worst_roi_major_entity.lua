...
local WorstRoiMajorEntity = {}
WorstRoiMajorEntity.__index = WorstRoiMajorEntity


function WorstRoiMajorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WorstRoiMajorEntity)
  self._name = "worst_roi_major"
  self._client = client
...
function WorstRoiMajorEntity:get_name()
  return self._name
end


function WorstRoiMajorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WorstRoiMajorEntity.new(self._client, opts)
end
...
function WorstRoiMajorEntity:mark_deleted()
  self._deleted = true
end


function WorstRoiMajorEntity:deleted()
  return true == self._deleted
end


function WorstRoiMajorEntity:data_set(args)
  if args ~= nil then
...
function WorstRoiMajorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WorstRoiMajorEntity:match_set(args)
  if args ~= nil then
...
function WorstRoiMajorEntity:match_get()
...
function WorstRoiMajorEntity:stream(action, args, callopts)
...
---@param reqmatch WorstRoiMajorListMatch
---@param ctrl? table
---@return WorstRoiMajor[]
---@return string? err
function WorstRoiMajorEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function WorstRoiMajorEntity:_run_op(ctx, post_done)
  local utility = self._utility

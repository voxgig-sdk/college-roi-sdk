...
local OpenapiEntity = {}
OpenapiEntity.__index = OpenapiEntity


function OpenapiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OpenapiEntity)
  self._name = "openapi"
  self._client = client
...
function OpenapiEntity:get_name()
  return self._name
end


function OpenapiEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OpenapiEntity.new(self._client, opts)
end
...
function OpenapiEntity:mark_deleted()
  self._deleted = true
end


function OpenapiEntity:deleted()
  return true == self._deleted
end


function OpenapiEntity:data_set(args)
  if args ~= nil then
...
function OpenapiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OpenapiEntity:match_set(args)
  if args ~= nil then
...
function OpenapiEntity:match_get()
...
function OpenapiEntity:stream(action, args, callopts)
...
---@param reqmatch OpenapiLoadMatch
---@param ctrl? table
---@return Openapi
---@return string? err
function OpenapiEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OpenapiEntity:_run_op(ctx, post_done)
  local utility = self._utility

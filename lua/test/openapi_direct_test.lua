...
describe("OpenapiDirect", function()
  it("should direct-load-openapi", function()
    local setup = openapi_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-openapi", setup.live and "live" or "unit")

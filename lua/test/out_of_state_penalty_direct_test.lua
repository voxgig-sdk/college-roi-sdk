...
describe("OutOfStatePenaltyDirect", function()
  it("should direct-list-out_of_state_penalty", function()
    local setup = out_of_state_penalty_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-out_of_state_penalty", setup.live and "live" or "unit")

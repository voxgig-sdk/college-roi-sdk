...
describe("Top50Direct", function()
  it("should direct-list-top_50", function()
    local setup = top_50_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-top_50", setup.live and "live" or "unit")

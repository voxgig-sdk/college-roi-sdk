...
describe("SlugDirect", function()
  it("should direct-load-slug", function()
    local setup = slug_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-slug", setup.live and "live" or "unit")

...
describe("BestValueDirect", function()
  it("should direct-list-best_value", function()
    local setup = best_value_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-best_value", setup.live and "live" or "unit")

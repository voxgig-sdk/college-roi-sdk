...
describe("MajorDirect", function()
  it("should direct-list-major", function()
    local setup = major_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-major", setup.live and "live" or "unit")

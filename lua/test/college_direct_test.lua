...
describe("CollegeDirect", function()
  it("should direct-list-college", function()
    local setup = college_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-college", setup.live and "live" or "unit")

...
describe("IndexDirect", function()
  it("should direct-load-index", function()
    local setup = index_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-index", setup.live and "live" or "unit")

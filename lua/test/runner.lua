...
function runner.env_override(m)
  local live = runner.getenv("COLLEGE_ROI_TEST_LIVE")
  local override = runner.getenv("COLLEGE_ROI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COLLEGE_ROI_TEST_EXPLAIN")

...
local SDK_MODULE = "college-roi_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["best_value"] = { ["test01"] = { id = "test01" } }, ["college"] = { ["test01"] = { id = "test01" } }, ["index"] = { ["test01"] = { id = "test01" } }, ["major"] = { ["test01"] = { id = "test01" } }, ["openapi"] = { ["test01"] = { id = "test01" } }, ["out_of_state_penalty"] = { ["test01"] = { id = "test01" } }, ["slug"] = { ["test01"] = { id = "test01" } }, ["state"] = { ["test01"] = { id = "test01" } }, ["top_50"] = { ["test01"] = { id = "test01" } }, ["worst_roi_major"] = { ["test01"] = { id = "test01" } } } }'

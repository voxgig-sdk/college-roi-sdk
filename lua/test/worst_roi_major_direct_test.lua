...
describe("WorstRoiMajorDirect", function()
  it("should direct-list-worst_roi_major", function()
    local setup = worst_roi_major_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-worst_roi_major", setup.live and "live" or "unit")

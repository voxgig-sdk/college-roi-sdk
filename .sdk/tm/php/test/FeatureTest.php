...
class FtCtrl extends CollegeRoiControl
{
...
class FtClient
{
    ...
    private CollegeRoiUtility $utility;

    public function __construct(CollegeRoiUtility $utility, array $options)
    {
    ...
    public function get_utility(): CollegeRoiUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (CollegeRoiContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public CollegeRoiContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (CollegeRoiContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = CollegeRoiConfig::make_feature($name);
    ...
    private static function buildUrl(CollegeRoiSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof CollegeRoiError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new CollegeRoiResponse($fetched);
        }
    ...
    private function fail(CollegeRoiContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (CollegeRoiContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;

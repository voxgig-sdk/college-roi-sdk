...
// CollegeRoi SDK timeout feature
...
class CollegeRoiTimeoutFeature extends CollegeRoiBaseFeature
{
    ...
    private function _with_timeout(CollegeRoiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CollegeRoiContext $_ctx, float $ms): void
    {
        $client = $this->client;

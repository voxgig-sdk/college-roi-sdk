...
// CollegeRoi SDK clienttrack feature
...
class CollegeRoiClienttrackFeature extends CollegeRoiBaseFeature
{
    ...
    public function PostConstruct(CollegeRoiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CollegeRoi-SDK';

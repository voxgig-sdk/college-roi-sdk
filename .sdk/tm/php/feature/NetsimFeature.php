...
class CollegeRoiNetsimFeature extends CollegeRoiBaseFeature
{
    ...
    private function _simulate(CollegeRoiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CollegeRoiContext $ctx, array $applied): void
    {
        $client = $this->client;

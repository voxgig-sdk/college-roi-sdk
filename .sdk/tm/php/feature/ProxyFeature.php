...
class CollegeRoiProxyFeature extends CollegeRoiBaseFeature
{
    ...
    public function init(CollegeRoiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CollegeRoiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

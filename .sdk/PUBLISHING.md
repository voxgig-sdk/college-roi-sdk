...
|---|---|---|
| `ts/` | @voxgig-sdk/college-roi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/college-roi-sdk \
      --repository voxgig-sdk/college-roi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/college-roi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/college-roi-sdk --id=<id>` removes it.

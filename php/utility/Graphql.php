...
// CollegeRoi SDK utility: graphql
//
...
class CollegeRoiGraphql
{
    ...
    // equivalent.
    public static function body(CollegeRoiContext $ctx): mixed
    {
    ...
    public static function errors(CollegeRoiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

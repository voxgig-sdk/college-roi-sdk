...
// CollegeRoi SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CollegeRoiTransformResponse
{
    public static function call(CollegeRoiContext $ctx): mixed
    {
        ...
        $transform = CollegeRoiHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }

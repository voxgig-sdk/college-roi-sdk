...
// CollegeRoi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CollegeRoiMakeRequest
{
    public static function call(CollegeRoiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CollegeRoiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CollegeRoiResponse($fetched);
        } else {

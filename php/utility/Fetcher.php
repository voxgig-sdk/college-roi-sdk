...
// CollegeRoi SDK utility: fetcher

class CollegeRoiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CollegeRoiSDK/1.0)';
    ...
    public static function call(CollegeRoiContext $ctx, string $fullurl, array $fetchdef): array
    {

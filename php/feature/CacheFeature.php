...
class CollegeRoiCacheFeature extends CollegeRoiBaseFeature
{
    ...
    private function _through(CollegeRoiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
// CollegeRoi SDK ratelimit feature
...
class CollegeRoiRatelimitFeature extends CollegeRoiBaseFeature
{
    ...
    private function _acquire(CollegeRoiContext $ctx): void
    {
    ...
    private function _track(CollegeRoiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

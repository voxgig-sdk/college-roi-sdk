...
// CollegeRoi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CollegeRoiTestFeature extends CollegeRoiBaseFeature
{
    ...
    public function init(CollegeRoiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CollegeRoiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CollegeRoiParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CollegeRoiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CollegeRoiContext $ctx, $op, $args): array
    {

...
class CollegeRoiRbacFeature extends CollegeRoiBaseFeature
{
    ...
    private function _required(CollegeRoiContext $ctx): ?string
    {
    ...
    private function _reject(CollegeRoiContext $ctx, string $required): void
    {
    ...
    private function _track(CollegeRoiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

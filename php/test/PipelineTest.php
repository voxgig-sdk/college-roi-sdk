...
{
    private static function utility(): CollegeRoiUtility
    {
        return new CollegeRoiUtility();
    }
    ...
    private static function ctx(array $over = []): CollegeRoiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CollegeRoiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CollegeRoiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CollegeRoiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CollegeRoiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CollegeRoiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CollegeRoiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CollegeRoiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CollegeRoiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CollegeRoiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CollegeRoiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CollegeRoiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CollegeRoiResponse([]),
            'result' => new CollegeRoiResult([]),
        ]);
        [, $err] = CollegeRoiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CollegeRoiSpec([]),
            'response' => null,
            'result' => new CollegeRoiResult([]),
        ]);
        [, $err] = CollegeRoiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CollegeRoiSpec(['step' => 's']),
            'response' => new CollegeRoiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CollegeRoiResult([]),
        ]);
        [, $err] = CollegeRoiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CollegeRoiSpec(['step' => 's']),
            'response' => new CollegeRoiResponse(self::resp(200, ['v' => 1])),
            'result' => new CollegeRoiResult([]),
        ]);
        [, $err] = CollegeRoiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CollegeRoiSpec(['step' => 's']),
            'response' => new CollegeRoiResponse(self::resp(200, ['v' => 2])),
            'result' => new CollegeRoiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CollegeRoiMakeResponse::call($ctx);
    ...
    {
        $preset = new CollegeRoiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CollegeRoiSpec([]),
            'response' => new CollegeRoiResponse([]),
            'result' => new CollegeRoiResult([]),
        ...
        [$got, $err] = CollegeRoiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CollegeRoiResult([])]);
        [, $err] = CollegeRoiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CollegeRoiSpec([]), 'result' => null]);
        [, $err] = CollegeRoiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CollegeRoiSpec(['step' => 's']),
            'result' => new CollegeRoiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CollegeRoiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CollegeRoiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CollegeRoiSpec(['step' => 's']),
            'result' => new CollegeRoiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CollegeRoiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CollegeRoiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CollegeRoiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CollegeRoiSpec([]),
            'result' => new CollegeRoiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CollegeRoiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CollegeRoiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CollegeRoiError('boom', 'boom');
        $utility->fetcher = function (CollegeRoiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CollegeRoiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CollegeRoiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CollegeRoiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CollegeRoiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CollegeRoiResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CollegeRoiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CollegeRoiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CollegeRoiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CollegeRoiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CollegeRoiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CollegeRoiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CollegeRoiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CollegeRoiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CollegeRoiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CollegeRoiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CollegeRoiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CollegeRoiResult(['ok' => false])]);
        $this->expectException(CollegeRoiError::class);
        CollegeRoiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CollegeRoiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CollegeRoiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CollegeRoiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CollegeRoiBaseFeature();
        $b = new CollegeRoiBaseFeature();
        CollegeRoiFeatureAdd::call($ctx, $a);
        CollegeRoiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CollegeRoiBaseFeature
    {
        $f = new CollegeRoiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CollegeRoiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CollegeRoiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CollegeRoiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CollegeRoiPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CollegeRoiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CollegeRoiResponse(['headers' => null]),
            'result' => new CollegeRoiResult([]),
        ]);
        CollegeRoiResultHeaders::call($ctx);

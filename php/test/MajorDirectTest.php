...
class MajorDirectTest extends TestCase
{
    public function test_direct_list_major(): void
    {
        $setup = major_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-major", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function major_direct_setup($mockres)
{

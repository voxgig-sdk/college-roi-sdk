...
// CollegeRoi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CollegeRoiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CollegeRoiOmni::structfix($now, Struct::undef()))
                        !== json_encode(CollegeRoiOmni::structfix($val, Struct::undef()))) {

...
class SlugDirectTest extends TestCase
{
    public function test_direct_load_slug(): void
    {
        $setup = slug_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-slug", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function slug_direct_setup($mockres)
{

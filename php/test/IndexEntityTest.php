...
class IndexEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COLLEGE_ROI_TEST_INDEX_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $index_ref01_match_dt0 = [];
        $index_ref01_data_dt0_loaded = $index_ref01_ent->load($index_ref01_match_dt0, null);
        $this->assertNotNull($index_ref01_data_dt0_loaded);
...
function index_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COLLEGE_ROI_TEST_INDEX_ENTID");

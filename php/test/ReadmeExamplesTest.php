...
// CollegeRoi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CollegeRoiSDK::test)
...
{
    private const SDK_CLASS = 'CollegeRoiSDK';
    ...
    private const SDK_BASE = 'collegeroi_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../collegeroi_sdk.php';

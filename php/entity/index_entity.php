...
class IndexEntity
{
     ...
     * Load a single Index.
     *
     * @param IndexLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IndexLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Index|array The loaded Index as an assoc-array at the

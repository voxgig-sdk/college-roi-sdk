...
// CollegeRoi SDK BestValue entity
...
class BestValueEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BestValueEntity($this->_client, $opts);
    }

    /**
     * @param BestValue|array $args BestValue data (assoc-array) to store.
     */
    ...
    /**
     * @return BestValue|array The current BestValue data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BestValue fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BestValue fields).
     */
    ...
    /**
     * List BestValue items matching the given filter.
     *
     * @param BestValueListMatch|array|null $reqmatch Match filter (any subset
     *   of BestValue fields) as an assoc-array; BestValueListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BestValue[]|array A list of BestValue items as assoc-arrays at

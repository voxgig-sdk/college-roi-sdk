...
// CollegeRoi SDK WorstRoiMajor entity
...
class WorstRoiMajorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorstRoiMajorEntity($this->_client, $opts);
    }

    /**
     * @param WorstRoiMajor|array $args WorstRoiMajor data (assoc-array) to store.
     */
    ...
    /**
     * @return WorstRoiMajor|array The current WorstRoiMajor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WorstRoiMajor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WorstRoiMajor fields).
     */
    ...
    /**
     * List WorstRoiMajor items matching the given filter.
     *
     * @param WorstRoiMajorListMatch|array|null $reqmatch Match filter (any subset
     *   of WorstRoiMajor fields) as an assoc-array; WorstRoiMajorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WorstRoiMajor[]|array A list of WorstRoiMajor items as assoc-arrays at

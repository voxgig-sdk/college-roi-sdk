...
class MajorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MajorEntity($this->_client, $opts);
    }

    /**
     * @param Major|array $args Major data (assoc-array) to store.
     */
    ...
    /**
     * @return Major|array The current Major data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Major fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Major fields).
     */
    ...
    /**
     * List Major items matching the given filter.
     *
     * @param MajorListMatch|array|null $reqmatch Match filter (any subset
     *   of Major fields) as an assoc-array; MajorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Major[]|array A list of Major items as assoc-arrays at

...
class StateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StateEntity($this->_client, $opts);
    }

    /**
     * @param State|array $args State data (assoc-array) to store.
     */
    ...
    /**
     * @return State|array The current State data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of State fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of State fields).
     */
    ...
    /**
     * List State items matching the given filter.
     *
     * @param StateListMatch|array|null $reqmatch Match filter (any subset
     *   of State fields) as an assoc-array; StateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return State[]|array A list of State items as assoc-arrays at

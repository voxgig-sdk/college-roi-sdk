...
class SlugEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SlugEntity($this->_client, $opts);
    }

    /**
     * @param Slug|array $args Slug data (assoc-array) to store.
     */
    ...
    /**
     * @return Slug|array The current Slug data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Slug fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Slug fields).
     */
     ...
     * Load a single Slug.
     *
     * @param SlugLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SlugLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Slug|array The loaded Slug as an assoc-array at the

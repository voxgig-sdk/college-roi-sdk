...
class CollegeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CollegeEntity($this->_client, $opts);
    }

    /**
     * @param College|array $args College data (assoc-array) to store.
     */
    ...
    /**
     * @return College|array The current College data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of College fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of College fields).
     */
    ...
    /**
     * List College items matching the given filter.
     *
     * @param CollegeListMatch|array|null $reqmatch Match filter (any subset
     *   of College fields) as an assoc-array; CollegeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return College[]|array A list of College items as assoc-arrays at

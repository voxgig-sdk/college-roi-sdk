...
class Top50Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Top50Entity($this->_client, $opts);
    }

    /**
     * @param Top50|array $args Top50 data (assoc-array) to store.
     */
    ...
    /**
     * @return Top50|array The current Top50 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Top50 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Top50 fields).
     */
    ...
    /**
     * List Top50 items matching the given filter.
     *
     * @param Top50ListMatch|array|null $reqmatch Match filter (any subset
     *   of Top50 fields) as an assoc-array; Top50ListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Top50[]|array A list of Top50 items as assoc-arrays at

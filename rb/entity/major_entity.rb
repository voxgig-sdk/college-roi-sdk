...
class MajorEntity
  ...
  # @return [Major, Hash] the current Major data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Major fields)
  def match_get
  ...
  #
  # @param reqmatch [MajorListMatch, Hash, nil] match filter (any subset of
  #   Major fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Major>, Array] the matching Major items; raises CollegeRoiError on failure

...
class WorstRoiMajorEntity
  ...
  def make
    opts = @_entopts.dup
    WorstRoiMajorEntity.new(@_client, opts)
  end
  ...
  # @return [WorstRoiMajor, Hash] the current WorstRoiMajor data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WorstRoiMajor fields)
  def match_get
  ...
  #
  # @param reqmatch [WorstRoiMajorListMatch, Hash, nil] match filter (any subset of
  #   WorstRoiMajor fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<WorstRoiMajor>, Array] the matching WorstRoiMajor items; raises CollegeRoiError on failure

...
class SlugEntity
  ...
  # @return [Slug, Hash] the current Slug data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Slug fields)
  def match_get
  ...
  # Load a single Slug.
  #
  # @param reqmatch [SlugLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Slug.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Slug, Hash] the loaded Slug; raises CollegeRoiError on failure

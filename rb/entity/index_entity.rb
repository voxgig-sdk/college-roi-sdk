...
class IndexEntity
  ...
  # Load a single Index.
  #
  # @param reqmatch [IndexLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Index.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Index, Hash] the loaded Index; raises CollegeRoiError on failure

...
class StateEntity
  ...
  # @return [State, Hash] the current State data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of State fields)
  def match_get
  ...
  #
  # @param reqmatch [StateListMatch, Hash, nil] match filter (any subset of
  #   State fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<State>, Array] the matching State items; raises CollegeRoiError on failure

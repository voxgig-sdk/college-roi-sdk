...
class CollegeEntity
  ...
  def make
    opts = @_entopts.dup
    CollegeEntity.new(@_client, opts)
  end
  ...
  # @return [College, Hash] the current College data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of College fields)
  def match_get
  ...
  #
  # @param reqmatch [CollegeListMatch, Hash, nil] match filter (any subset of
  #   College fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<College>, Array] the matching College items; raises CollegeRoiError on failure

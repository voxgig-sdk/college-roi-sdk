...
class Top50Entity
  ...
  # @return [Top50, Hash] the current Top50 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Top50 fields)
  def match_get
  ...
  #
  # @param reqmatch [Top50ListMatch, Hash, nil] match filter (any subset of
  #   Top50 fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Top50>, Array] the matching Top50 items; raises CollegeRoiError on failure

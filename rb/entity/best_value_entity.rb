...
class BestValueEntity
  ...
  def make
    opts = @_entopts.dup
    BestValueEntity.new(@_client, opts)
  end
  ...
  # @return [BestValue, Hash] the current BestValue data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BestValue fields)
  def match_get
  ...
  #
  # @param reqmatch [BestValueListMatch, Hash, nil] match filter (any subset of
  #   BestValue fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<BestValue>, Array] the matching BestValue items; raises CollegeRoiError on failure

...
const testSeed = `map[string]any{"entity": map[string]any{"best_value": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "college": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "index": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "major": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "openapi": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "out_of_state_penalty": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "slug": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "state": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "top_50": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "worst_roi_major": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

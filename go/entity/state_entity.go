...
func NewStateEntity(client *core.CollegeRoiSDK, entopts map[string]any) *StateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StateEntity) GetName() string { return e.name }
...
func (e *StateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StateEntity) Deleted() bool {
	return e.deleted
}


func (e *StateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStateEntity(e.client, opts)
}

func (e *StateEntity) Data(args ...any) any {
...
func (e *StateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *StateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *StateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

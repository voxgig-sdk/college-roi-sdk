...
func NewSlugEntity(client *core.CollegeRoiSDK, entopts map[string]any) *SlugEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SlugEntity) GetName() string { return e.name }
...
func (e *SlugEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SlugEntity) Deleted() bool {
	return e.deleted
}


func (e *SlugEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSlugEntity(e.client, opts)
}

func (e *SlugEntity) Data(args ...any) any {
...
func (e *SlugEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Slug; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SlugEntity) DataTyped(data ...Slug) Slug {
	if len(data) > 0 {
		return typedFrom[Slug](e.Data(asMap(data[0])))
	}
	return typedFrom[Slug](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Slug (all fields
// optional at the wire level).
func (e *SlugEntity) MatchTyped(match ...Slug) Slug {
	if len(match) > 0 {
		return typedFrom[Slug](e.Match(asMap(match[0])))
	}
	return typedFrom[Slug](e.Match())
}
...
func (e *SlugEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SlugEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SlugLoadMatch and returns an Slug. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SlugEntity) LoadTyped(reqmatch SlugLoadMatch, ctrl map[string]any) (Slug, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Slug{}, err
	}
	return typedFrom[Slug](res), nil
}



func (e *SlugEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SlugEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SlugEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SlugEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SlugEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

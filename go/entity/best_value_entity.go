...
func NewBestValueEntity(client *core.CollegeRoiSDK, entopts map[string]any) *BestValueEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BestValueEntity) GetName() string { return e.name }
...
func (e *BestValueEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BestValueEntity) Deleted() bool {
	return e.deleted
}


func (e *BestValueEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBestValueEntity(e.client, opts)
}

func (e *BestValueEntity) Data(args ...any) any {
...
func (e *BestValueEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BestValue; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BestValueEntity) DataTyped(data ...BestValue) BestValue {
	if len(data) > 0 {
		return typedFrom[BestValue](e.Data(asMap(data[0])))
	}
	return typedFrom[BestValue](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BestValue (all fields
// optional at the wire level).
func (e *BestValueEntity) MatchTyped(match ...BestValue) BestValue {
	if len(match) > 0 {
		return typedFrom[BestValue](e.Match(asMap(match[0])))
	}
	return typedFrom[BestValue](e.Match())
}
...
func (e *BestValueEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BestValueEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BestValueEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BestValueListMatch and returns []BestValue. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BestValueEntity) ListTyped(reqmatch BestValueListMatch, ctrl map[string]any) ([]BestValue, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[BestValue](res), nil
}



func (e *BestValueEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BestValueEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BestValueEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BestValueEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

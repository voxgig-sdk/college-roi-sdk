...
func NewIndexEntity(client *core.CollegeRoiSDK, entopts map[string]any) *IndexEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IndexEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IndexLoadMatch and returns an Index. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IndexEntity) LoadTyped(reqmatch IndexLoadMatch, ctrl map[string]any) (Index, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Index{}, err
	}
	return typedFrom[Index](res), nil
}



func (e *IndexEntity) List(_ map[string]any, _ map[string]any) (any, error) {

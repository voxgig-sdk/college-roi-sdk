...
func NewMajorEntity(client *core.CollegeRoiSDK, entopts map[string]any) *MajorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MajorEntity) GetName() string { return e.name }
...
func (e *MajorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MajorEntity) Deleted() bool {
	return e.deleted
}


func (e *MajorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMajorEntity(e.client, opts)
}

func (e *MajorEntity) Data(args ...any) any {
...
func (e *MajorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Major; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MajorEntity) DataTyped(data ...Major) Major {
	if len(data) > 0 {
		return typedFrom[Major](e.Data(asMap(data[0])))
	}
	return typedFrom[Major](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Major (all fields
// optional at the wire level).
func (e *MajorEntity) MatchTyped(match ...Major) Major {
	if len(match) > 0 {
		return typedFrom[Major](e.Match(asMap(match[0])))
	}
	return typedFrom[Major](e.Match())
}
...
func (e *MajorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MajorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MajorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MajorListMatch and returns []Major. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MajorEntity) ListTyped(reqmatch MajorListMatch, ctrl map[string]any) ([]Major, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Major](res), nil
}



func (e *MajorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MajorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MajorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MajorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

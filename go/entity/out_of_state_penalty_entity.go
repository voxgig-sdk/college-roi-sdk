...
type OutOfStatePenaltyEntity struct {
	name    string
	client  *core.CollegeRoiSDK
...
func NewOutOfStatePenaltyEntity(client *core.CollegeRoiSDK, entopts map[string]any) *OutOfStatePenaltyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutOfStatePenaltyEntity) GetName() string { return e.name }
...
func (e *OutOfStatePenaltyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutOfStatePenaltyEntity) Deleted() bool {
	return e.deleted
}


func (e *OutOfStatePenaltyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutOfStatePenaltyEntity(e.client, opts)
}

func (e *OutOfStatePenaltyEntity) Data(args ...any) any {
...
func (e *OutOfStatePenaltyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutOfStatePenalty; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutOfStatePenaltyEntity) DataTyped(data ...OutOfStatePenalty) OutOfStatePenalty {
	if len(data) > 0 {
		return typedFrom[OutOfStatePenalty](e.Data(asMap(data[0])))
	}
	return typedFrom[OutOfStatePenalty](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutOfStatePenalty (all fields
// optional at the wire level).
func (e *OutOfStatePenaltyEntity) MatchTyped(match ...OutOfStatePenalty) OutOfStatePenalty {
	if len(match) > 0 {
		return typedFrom[OutOfStatePenalty](e.Match(asMap(match[0])))
	}
	return typedFrom[OutOfStatePenalty](e.Match())
}
...
func (e *OutOfStatePenaltyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutOfStatePenaltyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *OutOfStatePenaltyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutOfStatePenaltyListMatch and returns []OutOfStatePenalty. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *OutOfStatePenaltyEntity) ListTyped(reqmatch OutOfStatePenaltyListMatch, ctrl map[string]any) ([]OutOfStatePenalty, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[OutOfStatePenalty](res), nil
}



func (e *OutOfStatePenaltyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OutOfStatePenaltyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutOfStatePenaltyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutOfStatePenaltyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
func NewCollegeEntity(client *core.CollegeRoiSDK, entopts map[string]any) *CollegeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CollegeEntity) GetName() string { return e.name }
...
func (e *CollegeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CollegeEntity) Deleted() bool {
	return e.deleted
}


func (e *CollegeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCollegeEntity(e.client, opts)
}

func (e *CollegeEntity) Data(args ...any) any {
...
func (e *CollegeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an College; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CollegeEntity) DataTyped(data ...College) College {
	if len(data) > 0 {
		return typedFrom[College](e.Data(asMap(data[0])))
	}
	return typedFrom[College](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through College (all fields
// optional at the wire level).
func (e *CollegeEntity) MatchTyped(match ...College) College {
	if len(match) > 0 {
		return typedFrom[College](e.Match(asMap(match[0])))
	}
	return typedFrom[College](e.Match())
}
...
func (e *CollegeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CollegeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CollegeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CollegeListMatch and returns []College. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CollegeEntity) ListTyped(reqmatch CollegeListMatch, ctrl map[string]any) ([]College, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[College](res), nil
}



func (e *CollegeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CollegeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CollegeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CollegeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

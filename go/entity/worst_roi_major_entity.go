...
type WorstRoiMajorEntity struct {
	name    string
...
func NewWorstRoiMajorEntity(client *core.CollegeRoiSDK, entopts map[string]any) *WorstRoiMajorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorstRoiMajorEntity) GetName() string { return e.name }
...
func (e *WorstRoiMajorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WorstRoiMajorEntity) Deleted() bool {
	return e.deleted
}


func (e *WorstRoiMajorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWorstRoiMajorEntity(e.client, opts)
}

func (e *WorstRoiMajorEntity) Data(args ...any) any {
...
func (e *WorstRoiMajorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WorstRoiMajor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WorstRoiMajorEntity) DataTyped(data ...WorstRoiMajor) WorstRoiMajor {
	if len(data) > 0 {
		return typedFrom[WorstRoiMajor](e.Data(asMap(data[0])))
	}
	return typedFrom[WorstRoiMajor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WorstRoiMajor (all fields
// optional at the wire level).
func (e *WorstRoiMajorEntity) MatchTyped(match ...WorstRoiMajor) WorstRoiMajor {
	if len(match) > 0 {
		return typedFrom[WorstRoiMajor](e.Match(asMap(match[0])))
	}
	return typedFrom[WorstRoiMajor](e.Match())
}
...
func (e *WorstRoiMajorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WorstRoiMajorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *WorstRoiMajorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WorstRoiMajorListMatch and returns []WorstRoiMajor. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WorstRoiMajorEntity) ListTyped(reqmatch WorstRoiMajorListMatch, ctrl map[string]any) ([]WorstRoiMajor, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[WorstRoiMajor](res), nil
}



func (e *WorstRoiMajorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WorstRoiMajorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WorstRoiMajorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WorstRoiMajorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

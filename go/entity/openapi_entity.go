...
func NewOpenapiEntity(client *core.CollegeRoiSDK, entopts map[string]any) *OpenapiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OpenapiEntity) GetName() string { return e.name }
...
func (e *OpenapiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OpenapiEntity) Deleted() bool {
	return e.deleted
}


func (e *OpenapiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOpenapiEntity(e.client, opts)
}

func (e *OpenapiEntity) Data(args ...any) any {
...
func (e *OpenapiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Openapi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OpenapiEntity) DataTyped(data ...Openapi) Openapi {
	if len(data) > 0 {
		return typedFrom[Openapi](e.Data(asMap(data[0])))
	}
	return typedFrom[Openapi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Openapi (all fields
// optional at the wire level).
func (e *OpenapiEntity) MatchTyped(match ...Openapi) Openapi {
	if len(match) > 0 {
		return typedFrom[Openapi](e.Match(asMap(match[0])))
	}
	return typedFrom[Openapi](e.Match())
}
...
func (e *OpenapiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OpenapiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OpenapiLoadMatch and returns an Openapi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OpenapiEntity) LoadTyped(reqmatch OpenapiLoadMatch, ctrl map[string]any) (Openapi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Openapi{}, err
	}
	return typedFrom[Openapi](res), nil
}



func (e *OpenapiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OpenapiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OpenapiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OpenapiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OpenapiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
describe('Top50Entity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'top_50.' + op, live)) return
    }
    ...
    let top_50_ref01_data = Object.values(setup.data.existing.top_50)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/top_50/Top50TestData.json')

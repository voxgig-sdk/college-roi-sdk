...
describe('SlugDirect', async () => {
  ...
  test('direct-load-slug', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-slug', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['COLLEGEROI_TEST_SLUG_ENTID']

...
function envOverride(m) {
    if ('TRUE' === process.env.COLLEGE_ROI_TEST_LIVE ||
        'TRUE' === process.env.COLLEGE_ROI_TEST_OVERRIDE) {
    ...
    m.COLLEGE_ROI_TEST_EXPLAIN = process.env.COLLEGE_ROI_TEST_EXPLAIN || m.COLLEGE_ROI_TEST_EXPLAIN;
    return m;
}

...
(0, node_test_1.describe)('SlugDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-slug', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-slug', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLLEGE_ROI_TEST_SLUG_ENTID'];
...
//# sourceMappingURL=SlugDirect.test.js.map
...
(0, node_test_1.describe)('CollegeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-college', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-college', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLLEGE_ROI_TEST_COLLEGE_ENTID'];
...
//# sourceMappingURL=CollegeDirect.test.js.map
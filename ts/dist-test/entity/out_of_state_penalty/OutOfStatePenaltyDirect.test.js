...
(0, node_test_1.describe)('OutOfStatePenaltyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CollegeRoiSDK({
    ...
    (0, node_test_1.test)('direct-list-out_of_state_penalty', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-out_of_state_penalty', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CollegeRoiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['COLLEGE_ROI_TEST_OUT_OF_STATE_PENALTY_ENTID'];
    ...
    const client = new __1.CollegeRoiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OutOfStatePenaltyDirect.test.js.map
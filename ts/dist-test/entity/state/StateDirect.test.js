...
(0, node_test_1.describe)('StateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-state', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-state', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["state01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLLEGE_ROI_TEST_STATE_ENTID'];
...
//# sourceMappingURL=StateDirect.test.js.map
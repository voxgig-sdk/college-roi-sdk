...
(0, node_test_1.describe)('IndexDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-index', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-index', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLLEGE_ROI_TEST_INDEX_ENTID'];
...
//# sourceMappingURL=IndexDirect.test.js.map
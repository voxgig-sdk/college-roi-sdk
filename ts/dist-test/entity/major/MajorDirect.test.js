...
(0, node_test_1.describe)('MajorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-major', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-major', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLLEGE_ROI_TEST_MAJOR_ENTID'];
...
//# sourceMappingURL=MajorDirect.test.js.map
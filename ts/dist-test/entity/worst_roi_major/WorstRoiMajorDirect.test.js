...
(0, node_test_1.describe)('WorstRoiMajorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-worst_roi_major', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-worst_roi_major', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLLEGE_ROI_TEST_WORST_ROI_MAJOR_ENTID'];
...
//# sourceMappingURL=WorstRoiMajorDirect.test.js.map
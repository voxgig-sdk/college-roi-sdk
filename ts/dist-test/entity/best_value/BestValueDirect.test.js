...
(0, node_test_1.describe)('BestValueDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-best_value', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-best_value', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLLEGE_ROI_TEST_BEST_VALUE_ENTID'];
...
//# sourceMappingURL=BestValueDirect.test.js.map
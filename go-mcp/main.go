// Command CollegeRoi-mcp is an MCP server exposing the CollegeRoi
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CollegeRoi_list  — list records of an entity
//	CollegeRoi_load  — load a single record of an entity
//
